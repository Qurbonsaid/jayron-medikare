...
// 	const { data, isLoading, isError } = useGetAllDiagnosisQuery({
// 		page: 1,
// 		limit: 100,
// 	})
...
// 		try {
// 			if (editingDisease) {
// 				await updateDisease({ id: editingDisease._id, data: payload }).unwrap()
// 				toast.success('Kasallik muvaffaqiyatli yangilandi 🎉')
// 			} else {
// 				await createDisease(payload).unwrap()
...
// 			toast.success("Kasallik o'chirildi")
// 			setDeleteId(null)
// 		} catch (error: any) {
// 			toast.error(error?.data?.message || "O'chirishda xatolik")
// 		}
// 	}
...
// 										Nomi: <span className='font-medium'>{param.name}</span>
// 									</p>
// 								</div>
