...
const NewVisit = () => {
  ...
  return (
    <main className='container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 max-w-6xl'>
      ...
      {!patient ? (
                ...
                <Command shouldFilter={false}>
                  ...
                  <CommandList onScroll={handlePatientScroll}>
                    <CommandEmpty className='py-6 text-sm sm:text-base'>
                      {isLoadingPatients ? 'Юкланмоқда...' : 'Бемор топилмади'}
                    </CommandEmpty>
                    <CommandGroup>
        ...
        <>
          {/* Patient Banner */}
          <Card className='card-shadow mb-4 sm:mb-6 bg-gradient-to-r from-primary/5 to-primary/10 p-4 sm:p-6 flex flex-wrap justify-between'>
            {/* Patient Info */}
            <div>
            ...
            <div className='flex flex-col lg:flex-row gap-4'>
              ...
              <div>
                <h4 className='text-sm font-medium mb-2'>Даволаш тури</h4>
          ...
          <div className='space-y-4 sm:space-y-6'>
            <div className='flex flex-wrap justify-between gap-x-3'>
              ...
              <Card className='card-shadow flex-1'>
                <div className='p-4 '>
                  <div className='px-2 flex items-center gap-2 sm:gap-3 mb-3'>
