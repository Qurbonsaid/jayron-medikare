		...
		<div className='min-h-screen bg-background p-4 sm:p-6 lg:p-8'>
			<div className='max-w-7xl mx-auto'>
				...
				<Tabs defaultValue='beds' className='space-y-6'>
					<TabsList className='grid w-full grid-cols-3 sm:grid-cols-5 flex-wrap gap-2  mb-11 relative z-10 bg-background'>
						<TabsTrigger value='beds'>Ётоқлар</TabsTrigger>
						<TabsTrigger value='admission'>Қабул</TabsTrigger>
						<TabsTrigger value='vitals'>Витал</TabsTrigger>
						<TabsTrigger value='mar'>Дори</TabsTrigger>
						<TabsTrigger value='fluids'>Суюқлик</TabsTrigger>
					</TabsList>
								...
								<div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
									...
									<div className='flex flex-wrap justify-center md:justify-end gap-3 text-sm'>
										...
										<div className='flex items-center gap-2'>
											...
											<span>
												Банд: {beds.filter(b => b.status === 'occupied').length}
											</span>
										</div>
							...
							<CardContent className='w-full overflow-x-hidden'>
								...
								<div className='space-y-6'>
									...
									<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4'>
										...
										<Card className='text-center sm:text-left'>
											<CardContent className='pt-4'>
												<Label className='text-xs sm:text-sm'>Юрак Уриши</Label>
												<div className='text-xl sm:text-2xl font-bold mt-2'>
